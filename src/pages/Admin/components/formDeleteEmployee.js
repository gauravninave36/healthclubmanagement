...
const FormDeleteEmployee = () => {
  ...
  const deleteEmployee = () => {
    axios
      .delete(config.serverURL + '/admin/employee/' + id)
      .then((Response) => {
      ...
      <form class='needs-validation' novalidate=''>
        <div class='row g-3'>
          ...
          <div class='col-6'>
            ...
            <select class='form-select' id='Role' required='' value={role}>
        ...
        <button class='w-100 btn btn-danger btn-lg' onClick={deleteEmployee}>
          Remove employee
        </button>
      </form>
    </div>
...
export default FormDeleteEmployee
